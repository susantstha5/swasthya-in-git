...
<head>
    ...
    <link rel="stylesheet" href="css/_topBanner.css">
<!--    <link href="css/_topMenu.css" rel="stylesheet">-->
<!--    <link href="css/_searchBar.css" rel="stylesheet">-->
<!--    <link href="css/_categoryMenu.css" rel="stylesheet">-->
    <link type="text/css" href="css/navigation/navigation.css" rel="stylesheet">
    <link href="css/_asideBar.css" rel="stylesheet">
    <link href="css/_testimonials.css" rel="stylesheet">
    <link href="css/modal.css" rel="stylesheet">
    <link href="css/category/category.css" rel="stylesheet">
    <link href="css/category/exclusive.css" rel="stylesheet">
...
<!--    --><?php //include('includes/_topMenu.php'); ?>
...
<!--        --><?php //include('includes/_categoryMenu.php'); ?>
        <!--   /.category-menu -->

        <?php include('includes/category/_category.php'); ?>
        <!--  /.category-section      -->
...
<!--<script src="design/assets/js/float-sidemenu.js"></script>-->
