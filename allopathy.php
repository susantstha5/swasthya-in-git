...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="css/_topBanner.css">
    ...
    <link href="css/category/allopathy-product-display.css" rel="stylesheet">
...
<div class="wrapper" id="site-wrapper">
    ...
    <div class="content-wrapper">
        ...
        <?php include('includes/category/exclusive/_allopathy-product-display.php'); ?>
