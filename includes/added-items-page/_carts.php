<div class="Cart__container___5UudH custom-top-margin">
   <div id="cart_section" >
        ...
        <div class="CartStepper__margin___rPxU6">
            <div class="u_flex-style">
                <div class="Step__step___3K1ts Step__step-active___H-r3g" style="width: 32.3333%;">
                    <div class="Step__title___cpJ5U">
                        STEP 1: My Cart
                    </div>
                </div>
                <div class="Step__step___3K1ts" style="width: 32.3333%;">
                    <div class="Step__title___cpJ5U">
       ...
       <div class="container-fluid">
           ...
           <div class="row Cart__cart-items___R-0Rk">
               ...
               <div class="col-xs-12 col-md-7"><div>
                       <div>
                           <div class="row">
                               <div class="col-xs-12 CartLineItems__section-title___2M9wJ">Items NOT Requiring Prescription (1)</div>
                           </div>
                           <div class="CartLineItems__item-list___2p3SB" id="cartContainerDetails">
                               <div class="CartLineItem__container___1w1IL" >
                                   <div class="row">
                                       <div class="col-xs-9">
                                           <div class="CartLineItem__name___3JS5V">3M N95 8210 Particulate Respirator Mask Pack of 2</div>
                                           <div class="CartLineItem__pack-size-label___xORIi">packet of 1 Mask</div>
                                       </div>
                                       <div class="col-xs-3 text-right">
                                           <div class="CartLineItem__price___1j-lm">Rs175</div>
                                           <div class="CartLineItem__actual-price___1Juw7">Rs 200 </div>
                                       </div>
                                   </div>
                                   <div class="row">
                                       <a class="button-text">
                                           <div class="col-xs-6">
                                               <!--                                        <img src="/images/delete_icon.svg" alt="delete icon" class="CartLineItem__delete-medicine___1oaAq">-->
                                               <i class="fa fa-trash-o fa-lg" aria-hidden="true"></i>
                                               <span class="CartLineItem__txt-delete-medicine___2PC18">Remove</span>
                                           </div>
                                       </a>
                                       <div class="col-xs-6 text-right">
                                           <div>
                                               ...
                                               <div id="clicker" class="Quantity__quantity___3V97B">
                                                   <a href="#"><i id="leftarrow" class="fa fa-minus fa-lg" aria-hidden="true"></i></a>

                                                   <span id="counter" class="Quantity__text___2EoLZ">1</span>

                                                   <a href="#"><i id="rightarrow" class="fa fa-plus fa-lg" aria-hidden="true"></i></a>
                                               </div>
                                           </div>
                                       </div>
                                   </div>
                   ...
                   <div class="CartSummary__outerContainer___1mopE">
                       <div class="row CartSummary__innerContainer___fqXQi">
                           <div class="col-xs-12 CartSummary__text___1vrNO">
                               ...
                               <span class="col-xs-6 text-right total-cart"></span>
                           </div>
                           <div class="col-xs-12 CartSummary__text___1vrNO">
                               <span class="col-xs-6">Price Discount</span>
                               <span class="col-xs-6 text-right ">- Rs 25</span>
                           </div>
                           <div class="col-xs-12 CartSummary__text___1vrNO">
                           ...
                           <div class="col-xs-12 CartSummary__totalAmount___dkw0Q">
                               ...
                               <span class="col-xs-6 text-right discount-cart"></span>
                           </div>
                        ...
                        <span class="col-xs-12 CartSummary__cart-summary-footer-text___211r2">Total Savings
                            <span class="CartSummary__savings-amount___1D_o0">Rs 25</span>
                        </span>
                           </div>
                       </div>
                   </div>
                   <div>
                       <a href="order-summary.php" class="t-dont-require-prescription Cart__desktop-button___2DRdC button-text " id="checkout" style="background-color: rgb(11, 197, 216); color: rgb(255, 255, 255); height: 40px; padding: 0px 16px; text-decoration: none; display: inline-flex; font-weight: 500; font-size: 16px; border-radius: 4px; z-index: 100; cursor: pointer; align-items: center; justify-content: center; border: 1px solid rgb(11, 197, 216);">
